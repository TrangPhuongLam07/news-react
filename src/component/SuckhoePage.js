...
import data from "../data/suckhoe_rss";
import {convertDate} from "./api/dateTime";

class SuckhoePage extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        document.title = "Sức khỏe";
        let page = "/Suc-Khoe/"
        return (
            <div className={"container mt-3"}>
                <div className={"warp warp--kind"}>
                    <h1 className={"wrap-title title-kind"}>Sức khỏe</h1>
                </div>
                ...
                <div>
                    {
                        this.state.listNew.slice(10,11).map((item) =>(
                            <div key ={item.id}  >
                ...
                <div className={"container-fluid"}>
                    ...
                    {this.state.listNew.slice(20,25).map((item)=>(
